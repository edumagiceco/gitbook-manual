...
export { TableOfContents as EditorTableOfContents } from './editor/TableOfContents';
export { EditorTabs, useEditorTabs } from './editor/EditorTabs';
export { FindReplaceModal } from './editor/FindReplaceModal';
